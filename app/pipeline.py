    ...
    def main(self):
        for replicate in range(self.n):
            try:
                ...
                recombined_fasta_fname = recombine(f"{'_'.join(seq_names)}.fasta", gene_to_recombine, self.expname, self.virus, self.data_dir)
...
if __name__ == "__main__":
    ...
    '''
    viruses = ["rhinovirus_a", "enterovirus_a71", "hiv_1", "hcmv"] 
    n = 100
